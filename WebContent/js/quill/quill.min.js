		...
		null==e&&(e=document.createElement("input"),
				...
				e.addEventListener("change",function(){
					if(null!=e.files&&null!=e.files[0]){
						...
						filedata.append('upload_file', e.files[0]);
						
						var _xml = new XMLHttpRequest();
						_xml.open('POST', 'boardImageUpload.jsp',true);
					
						_xml.onreadystatechange = function(){
							if(this.readyState == 4 && this.status == 200){
								var r=t.quill.getSelection(!0);
								t.quill.updateContents((new d.default).retain(r.index).delete(r.length).insert({image:"http://hanjicds001.gabia.io/images/upload/"+this.responseText}),v.default.sources.USER),
								t.quill.setSelection(r.index+1,v.default.sources.SILENT),e.value=""
							}
						};
						_xml.send(filedata);
